...
StoreDetails::StoreDetails() { //defualt c'tor set: serial,row,shelf,quantityand area

	cout << "StoreDetails  work" << endl;
...
void StoreDetails::setRowOfPlaceProduct() { //set row method
...
void StoreDetails::setSerialNumber() { //set serial number method
	int flag = 0;
	int serial;
...
void StoreDetails::setShelfOfProduct() { //set sheld method
	int num;
	int flag = 0;
...
void StoreDetails::printProduct()const { //print (virtual method)
...
void StoreDetails::writeToFile(ofstream& out) const {
	out << this->getSerialNumber() << " " << this->getRowOfPlaceProduct() << " " << this->getShelfOfProduct() << "(" << this->getQuantity() << "," << this->getTypeOfProduct() << "," << this->getAreaOfProductInTheStore() << ") ";
}
void StoreDetails::setQuantity() { //set quantity method
...
void StoreDetails::changeQuantity() { //option the change quantity method
	double num;
	int flag = 0;
...
void StoreDetails::setTypeOfProduct() { //set typeOfProduct: Agricultural or milk or Package method
	int num;
	int flag = 0;
...
void StoreDetails::setAreaOfProductInTheStore() { 
...
double StoreDetails::setPriceOfProduct(double num) const { 
	...
	return (factor * this->getQuantity()); 
...
StoreDetails::~StoreDetails() { 
	cout << "**the destractor of store details is successfully worked**" << endl;
}